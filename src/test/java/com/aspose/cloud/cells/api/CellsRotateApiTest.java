...
public class CellsRotateApiTest {
    ...
    @Test
    public void cellsPostRotateApiTest() throws ApiException {
        ...
        FilesResult response = api.postRotate(fileMap,"90","pdf",true);
