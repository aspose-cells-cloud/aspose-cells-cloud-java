...
public class Chart {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(link, autoScaling, backWall, categoryAxis, chartArea, chartDataTable, chartObject, depthPercent, elevation, firstSliceAngle, floor, gapDepth, gapWidth, heightPercent, hidePivotFieldButtons, is3D, isRectangularCornered, legend, name, nseries, pageSetup, perspective, pivotSource, placement, plotArea, plotEmptyCellsType, plotVisibleCells, printSize, rightAngleAxes, rotationAngle, secondCategoryAxis, secondValueAxis, seriesAxis, shapes, showDataTable, showLegend, sideWall, sizeWithWindow, style, title, type, valueAxis, walls, wallsAndGridlines2D);
  }
